  ...
  return (
    <header className="w-[100vw] py-6 px-5 flex justify-between items-center min-h-[10vh]">
        ...
        <nav>
            ...
            <Link to="/about" className="text-black hover:text-red-700"><li className="px-8 text-sm font-semibold">About</li></Link>
            <Link to="/gallery" className="text-black hover:text-red-700"><li className="px-8 text-sm font-semibold">Gallery</li></Link>
            <Link to="/events" className="text-black hover:text-red-700"><li className="px-8 text-sm font-semibold">Contact Us</li></Link>
            </ul>
        </nav>
        <div>
